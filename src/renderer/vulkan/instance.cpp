...
namespace arbor {
    namespace engine {
        VkBool32 VKAPI_PTR debug_messenger_callback(VkDebugUtilsMessageSeverityFlagBitsEXT severity,
        ...
        std::expected<void, std::string> renderer::make_vk_instance() {
            ...
            m_logger->trace("creating a vulkan instance with {} extensions: {}", vk.instance_ext.size(),
                            fmt::join(vk.instance_ext, ", "));
